...
if wc_l_norm >= 0 && wc_u_norm <= 1 && wc_l_norm < wc_u_norm
    % Projeto do filtro passa-banda FIR com 'remez'
    filt_bp = fir1(30, [0 wc_l_norm wc_u_norm 1], [0 1 0]); % Filtro FIR passa-banda
...
% Magnitude do sinal recuperado (FFT)
subplot(5,1,3); 
